...
LOCK
TABLES `product_descriptions` WRITE;
INSERT INTO `product_descriptions`
VALUES (1, 1, 'tr', 'dasasd888', 'dsads', 'adsdas', 'dsa', 'dsaads', 'dsaads', 'dasads', '<p>sdaa</p>\r\n', 'sdads'),
       (2, 2, 'tr', 'dasasd', 'dsads', 'adsdas', 'dsa', 'dsaads', 'dsaads', 'dasads', '<p>sdaa</p>\r\n', 'sdads'),
       (3, 3, 'tr', 'das', 'dsa', 'dsa', 'dsa', 'dsa', 'dasdsa', 'dsasd', '<p>asddsaads</p>\r\n', 'adsads'),
       (4, 4, 'tr', 'dsafdsfds', 'dfsdfsfds', 'fdsfds', 'sdfdfs', 'dfsfddfsfds', 'fdsfdsfd', 'fdsfds', '<p>dfs</p>\r\n',
        'fdssdf'),
       (5, 5, 'tr', 'dsafds', 'fsdfdssdf', 'dfsfds', 'fdsfds', 'dfsfdsdfs', 'dfsfdsdfs', 'dfsfdsdfs',
        '<p>fdsdfssfdsdsf</p>\r\n', 'dfsfdsd'),
       (6, 6, 'tr', 'dsa', 'dsa', 'ads', 'sda', 'dsa', 'dsa', 'dsa', '<p>das</p>\r\n', 'dasds'),
       (7, 7, 'tr', 'daasd', 'ghj', 'hgh', 'ghj', 'ghjg', 'jgh', 'ghj', '<p>jhggjh</p>\r\n', 'ghj'),
       (8, 8, 'tr', 'dsadas', 'ggfhg', 'gfh', 'gfh', 'fhgfg', 'ghf', 'gfh', '<p>fhg</p>\r\n', 'fhghfg');
UNLOCK
TABLES;
...
LOCK
TABLES `product_discounts` WRITE;
INSERT INTO `product_discounts`
VALUES (18, 1, 'Müşteri', 1, 19696.0000, 'price', 'TL', NULL, NULL),
       (19, 1, 'Müşteri', 1, 120.0000, 'price', 'TL', NULL, NULL),
       (20, 1, 'Müşteri', 1, 2322.0000, 'price', 'TL', NULL, NULL);
UNLOCK
TABLES;
...
LOCK
TABLES `product_prices` WRITE;
INSERT INTO `product_prices`
VALUES (9, 3, 'TL', 1.0000, 1),
       (10, 3, 'USD', 1.0000, 1),
       (11, 3, 'EUR', 1.0000, 1),
       (12, 3, 'TL', 1.0000, 2),
       (13, 4, 'TL', 1.0000, 1),
...
VALUES (1, 'd0da48ee-624c-70f1-9ded-b4679a85f1df', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 0, 1, 1, '1',
        'Screenshot_2026-02-03_at_00_36_03.png', '2026-02-01 11:39:26', '2026-02-03 13:03:26'),
       (2, 'd0da48ee-624c-70f1-9ded-b4679a85f1df', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 0, '1',
        'ed54d89432f125b28c533725627d230a.png', '2026-02-01 11:40:36', '2026-02-01 11:40:36'),
       (3, 'd0da48ee-624c-70f1-9ded-b4679a85f1df', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 0, '1',
        '450bb6249df469db0ecfc289b2dd1a83.png', '2026-02-01 11:52:21', '2026-02-01 11:52:21'),
       (4, 'd0da48ee-624c-70f1-9ded-b4679a85f1df', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 1, '1',
        'c686142819831d05d72d6e90a491742b.png', '2026-02-01 11:57:47', '2026-02-01 11:57:47'),
       (5, 'd0da48ee-624c-70f1-9ded-b4679a85f1dk', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 1, '1',
        '8609fd037b82717e7f2d5d388c415aac.png', '2026-02-01 12:05:35', '2026-02-01 12:05:35'),
       (6, 'd0da48ee-624c-70f1-9ded-b4679a85f1dg', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 1, '1',
        '646b4ce77ba7b175696830daeef02b4f.png', '2026-02-01 13:07:22', '2026-02-01 13:07:22'),
       (7, 'd0da48ee-624c-70f1-9ded-b4679a85f1df', 1, 1, 18.00, 10, 1, 1, '2026-08-12', 1, 1, 1, 0, '1',
        'fec4746f6942b10c61ad69ce464c8b9c.png', '2026-02-01 14:31:09', '2026-02-01 14:31:09'),
       (8, 'dfdsdfs', 3, 1, 18.00, 10, 0, 1, '2026-08-12', 0, 0, 1, 1, '3', 'Screenshot_2026-02-02_at_14_20_40.png',
        '2026-02-02 11:34:58', '2026-02-03 13:03:04');
UNLOCK
TABLES;
